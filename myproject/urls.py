...
urlpatterns = [
    ...
    path('helpands',views.helpands, name="helpands"),
    path('login',views.login, name="login"),
    path('lcancer',views.lcancer, name="lcancer"),
    path('mprofile',views.myprofile, name="mprofile"),
    path('register', views.register, name="register"),
    path('review',views.review, name="review"),
    path('doctors', views.view_doctor, name="doctors"),
    path('hospitals',views.view_hospital, name="hospitals"),
    ...
    path('skincancer',views.skinc, name="skincancer"),
    path('ccancervisual',views.ccancervis, name="ccancervisual"),
    path('cervis1', views.vis1, name="cervis1"),
    path('cervis2',views.vis2,name="cervis2"),
    path('predict',views.predictormain, name="predict"),
    path('nnews',views.news, name="nnews"),
